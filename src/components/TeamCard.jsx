...
const TeamCard = () => {
  return (
    <section className='bg-[#fafafa] pt-[75px] pb-[100px]'>
      <div className='container'>
        <div className='mb-[60px] w-[250px] md:w-[760px] h-[205px] flex flex-col justify-center items-center text-center mx-auto'>
          ...
          <p className='font-medium text-[14px] leading-[20px] text-text-color w-[230px] md:w-[470px] mt-[10px]'>
        ...
        >
          ...
          {card.map(member => (
            <SwiperSlide key={member.id}>
              <Team img={member.img} h6={member.h6} span={member.span} para={member.para} />
            </SwiperSlide>
          ))}
          </div>
        </Swiper>
  ...
  return (
    <div className='bg-[#fff] px-[100px] lg:px-[50px] py-[30px] w-[335px] lg:w-[240px] mx-auto mb-[30px]'>
      ...
      <div className='text-center'>
        ...
        <p className='font-medium text-[14px] leading-[20px] text-second-text-color w-[150px] mx-auto'>{para}</p>
      </div>
    </div>
  );
};
